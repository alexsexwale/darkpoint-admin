...
export function Sidebar() {
  ...
  return (
    <aside
      className={clsx(
        'fixed left-0 top-0 z-40 h-screen bg-dark-2 border-r border-dark-4 transition-all duration-300 flex flex-col',
    ...
    >
      ...
      <div className="border-t border-dark-4 p-3">
        ...
        <button
          ...
          className={clsx(
            'flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-5 hover:bg-dark-3 hover:text-gray-1 transition-colors w-full',
            collapsed && 'justify-center px-0'
          )}
        >
          {collapsed ? (
